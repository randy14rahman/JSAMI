...
/** \Pomegranate\framework\RpcServer\RpcInterface */
require_once 'RpcInterface.class.php';
 ...
 */
abstract class RpcAbstract implements RpcInterface
{
    /**
    ...
    /**
     * Request object
     * @var \Pomegranate\framework\RpcServer\Request
     */
    protected $_request;
    
    /**
     * Response object
     * @var \Pomegranate\framework\RpcServer\Response
     */
    protected $_response;
     ...
     * Set response object
     *
     * @param  \Pomegranate\framework\RpcServer\Response $response
     * @return \Pomegranate\framework\RpcServer
     */
    public function setResponse(\Pomegranate\framework\RpcServer\Response $response)
    {
