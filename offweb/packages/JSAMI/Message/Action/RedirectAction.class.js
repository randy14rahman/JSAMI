...
Pomegranate.extend(".JSAMI.Message.Action.ActionMessage", __CLASS__, {
	init: function(channel, extension, context, priority) {
	...
	, setExtraChannel: function(channel) {
		this.setKey("ExtraChannel", channel);
	}
	, setExtraExtension: function(extension) {
		this.setKey("ExtraExten", extension);
	}
	, setExtraContext: function(context) {
		this.setKey("ExtraContext", context);
	}
	, setExtraPriority: function(priority) {
